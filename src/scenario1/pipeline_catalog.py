...
PIPELINE_STAGES = (
    ...
    PipelineStage(
        "S03",
        "Construction",
        "Prepare a retrieval plan",
        "package changes",
        "local only",
        ("scripts/01_scenario_construction/00_prepare_retrieval_plan.py",),
        ("S02",),
        "Clean-ranked, hash-bound retrieval plan",
    ),
    PipelineStage(
        "S04",
        "Construction",
    ...
    PipelineStage(
        "S06",
        "Construction",
        "Preflight context and render retrieval review",
        "package changes",
        "local only",
        (
            "scripts/01_scenario_construction/03_preflight_retrieval_context.py",
            "scripts/01_scenario_construction/04_render_retrieval_review.py",
        ),
        ("S05",),
        "Tokenizer-bound context check and review material",
    ),
    PipelineStage(
        "S07",
        "Modal",
