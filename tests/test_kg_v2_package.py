"""Review controls for the Knowledge Graphs v2 package."""
...
KG_REGISTRY_PATH = KG_ROOT / "registry_gen5000_v2.json"
MACRO_REGISTRY_PATH = (
...
def test_kg_payload_is_classified_from_the_pinned_qwen_tokenizer_audit():
    ...
    plan = _load_json(
        KG_ROOT / "retrieval" / "full_corpus_bm25_balanced_gen5000_v2.json"
    )
    preflight = _load_json(
        KG_ROOT / "retrieval" / "qwen_context_preflight_balanced_gen5000_v2.json"
    )
