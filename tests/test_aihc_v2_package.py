"""Publication metadata and privacy checks for the AIHC v2 package."""
...
def test_aihc_v2_source_licenses_and_registry_scope_are_explicit():
...
def test_aihc_v2_phi_hygiene_covers_both_materialized_arms():
