...
| `scripts/04_reporting/` | Rebuild paper and public-facing reporting assets from saved results. |
| `scripts/90_runway_reproduction/` | Reproduce the earlier Llama 3.1 8B measurement runway. |
| `docs/assets/` | Selected public-facing figures generated by the reporting scripts. |
| `docs/data/scenario1/` | Compact tracked metrics and provenance used to rebuild public figures. |
...
| 11 | `scripts/03_probe_analysis/11_analyze_depth_degradation.py` | Temporal path-mean metrics, signed Temporal Divergence, bootstrap intervals, and depth summaries |
| 12 | `scripts/03_probe_analysis/12_plot_probe_analysis.py` | Final probe figures, result tables, analysis manifest, and compact public snapshot |
| 13 | `scripts/04_reporting/13_plot_pipeline_overview.py` | Public pipeline overview in PNG, SVG, and PDF |
| 14 | `scripts/04_reporting/14_plot_investor_figures.py` | Public result-summary figures in PNG, SVG, and PDF |
| 15 | `scripts/04_reporting/15_build_reporting_bundle.py` | Rebuild all paper and public-facing reporting outputs in order |
...
| `results/scenario1/depth_analysis/` | Temporal path-mean metrics, signed Temporal Divergence records, and depth comparisons |
...
| `docs/assets/` | Selected regenerated figures used in the public README and presentations |
| `docs/data/scenario1/reporting_snapshot.json` | Versioned compact inputs, model configuration, source hashes, and analysis/reporting code revisions |
